package com.teksiak.run.presentation.active_run.maps
...
import com.teksiak.core.presentation.designsystem.RuniqueYellow
...
object PolylineColorCalculator {
    ...
    fun locationsToColor(location1: LocationTimestamp, location2: LocationTimestamp): Color {
        ...
        return interpolateColor(
            ...
            minSpeed = 5.0,
            maxSpeed = 20.0,
            colorStart = RuniqueGreen,
            colorMid = RuniqueYellow,
            colorEnd = RuniqueDarkRed
        )
    }
