package com.teksiak.wear.run.presentation.ambient
...
fun Modifier.ambientMode(
    ...
    val translationX by rememberBurnTranslation(isAmbientMode, burnInProtectionRequired)
    val translationY by rememberBurnTranslation(isAmbientMode, burnInProtectionRequired)
...
@Composable
private fun rememberBurnTranslation(
    isAmbientMode: Boolean,
    burnInProtectionRequired: Boolean
): State<Float> {
